...
int hipsPreheatHotendTemp;
int hipsPreheatHPBTemp;
int hipsPreheatFanSpeed;
...
int polycarbonatePreheatFanSpeed;

int tglasePreheatHotendTemp;
int tglasePreheatHPBTemp;
int tglasePreheatFanSpeed;
...
static void lcd_main_menu()
{
    ...
    if (movesplanned() || IS_SD_PRINTING)
    {
        ...
        MENU_ITEM(submenu, MSG_TEMPERATURE_MENU, lcd_temperature_menu);
    }
...
void lcd_preheat_hips()
{
    ...
    setTargetHotend1(hipsPreheatHotendTemp);
    setTargetHotend2(hipsPreheatHotendTemp);
...
void lcd_preheat_alloy_910()
{
    ...
    setTargetHotend1(alloy_910PreheatHotendTemp);
    setTargetHotend2(alloy_910PreheatHotendTemp);
    setTargetBed(alloy_910PreheatHPBTemp);
    fanSpeed = alloy_910PreheatFanSpeed;
    lcd_return_to_status();
    setWatch(); // heater sanity check timer
}
...
void lcd_preheat_n_vent()
{
    ...
    setTargetHotend1(n_ventPreheatHotendTemp);
    setTargetHotend2(n_ventPreheatHotendTemp);
    setTargetBed(n_ventPreheatHPBTemp);
    fanSpeed = n_ventPreheatFanSpeed;
    lcd_return_to_status();
    setWatch(); // heater sanity check timer
}
...
void lcd_preheat_polycarbonate()
{
    setTargetHotend0(polycarbonatePreheatHotendTemp);
    setTargetHotend1(polycarbonatePreheatHotendTemp);
    setTargetHotend2(polycarbonatePreheatHotendTemp);
    setTargetBed(polycarbonatePreheatHPBTemp);
    fanSpeed = polycarbonatePreheatFanSpeed;
    lcd_return_to_status();
    setWatch(); // heater sanity check timer
}
void lcd_preheat_tglase()
{
    setTargetHotend0(tglasePreheatHotendTemp);
    setTargetHotend1(tglasePreheatHotendTemp);
    setTargetHotend2(tglasePreheatHotendTemp);
    setTargetBed(tglasePreheatHPBTemp);
    fanSpeed = tglasePreheatFanSpeed;
    lcd_return_to_status();
    setWatch(); // heater sanity check timer
}
...
static void lcd_control_temperature_menu()
{
    ...
    START_MENU();
    MENU_ITEM(back, MSG_TEMPERATURE_MENU, lcd_temperature_menu);
#if TEMP_SENSOR_0 != 0
...
static void lcd_control_temperature_preheat_alloy_910_settings_menu()
{
    START_MENU();
    MENU_ITEM(back, MSG_TEMPERATURE, lcd_control_temperature_menu);
    MENU_ITEM_EDIT(int3, MSG_FAN_SPEED, &alloy_910PreheatFanSpeed, 0, 255);
#if TEMP_SENSOR_0 != 0    
    MENU_ITEM_EDIT(int3, MSG_NOZZLE, &alloy_910PreheatHotendTemp, 0, HEATER_0_MAXTEMP - 15);
#endif    
#if TEMP_SENSOR_BED != 0
    MENU_ITEM_EDIT(int3, MSG_BED, &alloy_910PreheatHPBTemp, 0, BED_MAXTEMP - 15);
#endif
#ifdef EEPROM_SETTINGS
    MENU_ITEM(function, MSG_STORE_EPROM, Config_StoreSettings);
#endif
...
static void lcd_control_temperature_preheat_n_vent_settings_menu()
{
    START_MENU();
    MENU_ITEM(back, MSG_TEMPERATURE, lcd_control_temperature_menu);
    MENU_ITEM_EDIT(int3, MSG_FAN_SPEED, &n_ventPreheatFanSpeed, 0, 255);
#if TEMP_SENSOR_0 != 0    
    MENU_ITEM_EDIT(int3, MSG_NOZZLE, &n_ventPreheatHotendTemp, 0, HEATER_0_MAXTEMP - 15);
#endif    
#if TEMP_SENSOR_BED != 0
    MENU_ITEM_EDIT(int3, MSG_BED, &n_ventPreheatHPBTemp, 0, BED_MAXTEMP - 15);
#endif
#ifdef EEPROM_SETTINGS
    MENU_ITEM(function, MSG_STORE_EPROM, Config_StoreSettings);
#endif
...
static void lcd_control_temperature_preheat_polycarbonate_settings_menu()
{
    START_MENU();
    MENU_ITEM(back, MSG_TEMPERATURE, lcd_control_temperature_menu);
    MENU_ITEM_EDIT(int3, MSG_FAN_SPEED, &polycarbonatePreheatFanSpeed, 0, 255);
#if TEMP_SENSOR_0 != 0
    MENU_ITEM_EDIT(int3, MSG_NOZZLE, &polycarbonatePreheatHotendTemp, 0, HEATER_0_MAXTEMP - 15);
#endif    
#if TEMP_SENSOR_BED != 0
    MENU_ITEM_EDIT(int3, MSG_BED, &polycarbonatePreheatHPBTemp, 0, BED_MAXTEMP - 15);
#endif
#ifdef EEPROM_SETTINGS
    MENU_ITEM(function, MSG_STORE_EPROM, Config_StoreSettings);
#endif
...
static void lcd_control_temperature_preheat_tglase_settings_menu()
{
    START_MENU();
    MENU_ITEM(back, MSG_TEMPERATURE, lcd_control_temperature_menu);
    MENU_ITEM_EDIT(int3, MSG_FAN_SPEED, &tglasePreheatFanSpeed, 0, 255);
#if TEMP_SENSOR_0 != 0
    MENU_ITEM_EDIT(int3, MSG_NOZZLE, &tglasePreheatHotendTemp, 0, HEATER_0_MAXTEMP - 15);
#endif    
#if TEMP_SENSOR_BED != 0
    MENU_ITEM_EDIT(int3, MSG_BED, &tglasePreheatHPBTemp, 0, BED_MAXTEMP - 15);
#endif
#ifdef EEPROM_SETTINGS
    MENU_ITEM(function, MSG_STORE_EPROM, Config_StoreSettings);
#endif
